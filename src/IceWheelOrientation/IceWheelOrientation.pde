...
void setup()
{
  ...
  myPort = new Serial(this, "\\\\.\\COM3", 9600); // Windows, COM10 or higher
...
void drawIceWheel()
{
  ...
  fill(139, 90, 4); // fill color
  box(scale*190, scale*10, scale*70); // PCB base shape
  
  fill(64,64,64); // fill color

  drawCylinder(50, scale*35, scale*50);
